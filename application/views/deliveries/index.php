				...
				<tbody>
					<?php foreach($dataSet as $data): ?> 
						<tr>
							...
							<td><a onclick="return window.confirm('Yakin mau dihapus?');" href="<?php echo base_url('DeliveriesController/destroy/') ?><?php echo $data['id'] ?>" class="btn btn-danger btn-sm">Delete</a></td>
						</tr>
					<?php endforeach; ?>
				</tbody>
			</table>
