							...
							<tbody>
								...
								<?php foreach($accountsList as $account) :?>
									<tr>
										...
										<td><a onclick="return window.confirm('Yakin mau dihapus?');" href="<?php echo base_url("UsersController/delete/$id"); ?>" class="btn btn-danger btn-sm" <?php echo SITE_LIVE ? 'disabled onclick="return false;"' : '' ?>>Delete</a></td>
									</tr>
								<?php endforeach;?>
							</tbody>
						</table>
