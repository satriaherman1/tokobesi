     ...
     <div class="panel panel-default">
        ...
        <div class="col-md-6">
            <div class="sale-widget text-center">
                All Time<br>
                <b><span id="total-sales">Rp. <?php echo number_format($allTime[0]->cost,2) ?></span></b>
            </div>
        </div>
        <div class="col-md-6">
            <div class="sale-widget text-center">
                This Month<br>
                <b><span id="total-profit">Rp. <?php echo number_format($thisMonth[0]->cost,2) ?></span></b>
            </div>
        </div>
             		...
             		<tbody>
             		     <?php foreach ($expenses as $expense): ?>
                            <tr>
                                ...
                                <td>Rp. <?php echo number_format($expense->cost,2) ?></td>
