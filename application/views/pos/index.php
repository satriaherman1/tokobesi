				...
				<nav class="navbar">
					...
					<ul class="nav navbar-nav navbar-right">
						<?php if ($this->session->userdata('account_type') !== "Cashier") : ?>
							<li><a href="<?php echo base_url('items') ?>">Invetaris</a></li>
						<?php endif; ?>
						<li class="dropdown">
		...
		<div class="">
			<div class=" header">
				<div class="col-sm-7 box rightnone">
					...
					<div class="content">
						<label>Pilih Barang yang dipesan</label>
					...
					<div class="col-md-12" style="padding: 15px 25px;">
						<form id="process-form">
							<div class="form-group">
								<input type="text" class="form-control" name="" placeholder="Enter Payment" id="payment" autocomplete="off" maxlength="6">
							</div>
							<div class="form-group">
